...
\input{sections/periodic_orbits}
\input{sections/hill_regions}
...
software environment. The complete code and verified result files are available in a public
repository, with an immutable snapshot archived for the published version. The
identifiers are: \emph{repository:}
\url{https://github.com/drmshoaib/4-1-body-problem};\ \emph{release tag:}
\texttt{v1.0-paper-submission};\ \emph{archive DOI:}
[to be added on Zenodo deposit]. Full numerical settings and per-file
provenance are documented in the repository README.
